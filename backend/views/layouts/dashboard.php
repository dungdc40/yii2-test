...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg">Inventory management </span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li>
                ...
                <i class="fa fa-calendar"></i> <span>Items Overview</span>
              </a>
            </li>
			<li class="header">Items</li>
			<li>
				<a href="<?php echo Url::to(['/items']);?>">
                <i class="fa fa-calendar"></i> <span>Item management</span>
              </a>
            </li>
...
<?php if (isset($this->blocks['customJs'])): ?>
    <?= $this->blocks['customJs'] ?>
<?php endif; ?>
</body>
</html>
<?php $this->endPage() ?>
